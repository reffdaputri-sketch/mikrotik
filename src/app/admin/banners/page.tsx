...
export default function AdminBannersPage() {
  ...
  async function handleSave(e: React.FormEvent) {
    e.preventDefault()
    if (!imageUrl) {
      alert('Gambar wajib diisi/diupload!')
      return
    }
  ...
  return (
    <div className="page-content">
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 className="page-title">Manajemen Banner Promo</h1>
          <p className="page-subtitle">Kelola tampilan slide promo di halaman depan</p>
        </div>
        <button 
                  ...
                  <tr key={b.id}>
                    <td>
                      <div style={{ 
                        ...
                        background: `url(${b.image_url}) center/cover`,
                    ...
                    <td>
                      ...
                      {b.link_url && <div style={{ fontSize: '0.75rem', color: '#64748b' }}>Link: {b.link_url}</div>}
                    </td>
                    <td>
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <h2 style={{ fontSize: '1.25rem', fontWeight: 700 }}>{editingId ? 'Edit Banner' : 'Tambah Banner Baru'}</h2>
            </div>
            <form onSubmit={handleSave} className="modal-body">
              <div style={{ marginBottom: '16px' }}>
                <label className="form-label">Judul Promo / Banner</label>
                <input 
                  type="text" className="form-input" required
                  value={title} onChange={e => setTitle(e.target.value)}
                  placeholder="Misal: Promo Akhir Tahun 50Mbps"
                />
              </div>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                  <label className="btn btn-secondary btn-sm" style={{ cursor: 'pointer' }}>
                    <ImageIcon size={14} /> {uploading ? 'Mengupload...' : 'Upload dari PC'}
                ...
                />
                {imageUrl && (
                  <div style={{ marginTop: '12px', borderRadius: '10px', overflow: 'hidden', border: '1px solid #334155', boxShadow: '0 4px 12px rgba(0,0,0,0.3)' }}>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <input 
                  ...
                  placeholder="https://..."
                />
                <p style={{ fontSize: '0.7rem', color: '#64748b', marginTop: '4px' }}>Jika diklik, banner akan mengarah ke link ini.</p>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '12px', background: 'rgba(255,255,255,0.03)', borderRadius: '8px' }}>
                ...
                />
                <label htmlFor="isActive" style={{ fontSize: '0.875rem', cursor: 'pointer', color: '#e2e8f0' }}>Tampilkan Banner ini di halaman depan</label>
              </div>
