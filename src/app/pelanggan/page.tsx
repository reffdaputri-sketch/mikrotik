...
export default function PelangganDashboard() {
  ...
  async function handlePayWithWallet() {
    if (!confirm(`Tolak saldo ${formatCurrency(customer.plans?.price)} untuk perbaharui pakej?`)) return
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '24px' }}>
        ...
        <div style={{ 
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
              <span style={{ fontSize: '13px', fontWeight: 600, opacity: 0.9 }}>Baki Saldo Wallet</span>
          ...
          <div style={{ 
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ display: 'grid', gap: '14px' }}>
                ...
                >
                  <Zap size={18} /> {hasPlan ? 'BAYAR GUNA SALDO WALLET' : 'SILA BELI PAKEJ DULU'}
                </button>
        ...
        {activeTab === 'wallet' && (
          <div style={{ background: 'white', padding: '28px', borderRadius: '24px', border: '1px solid #dcfce7', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
            <h3 style={{ fontSize: '20px', fontWeight: 900, color: '#166534', marginBottom: '20px' }}>Riwayat Mutasi Saldo</h3>
            <div style={{ display: 'grid', gap: '12px' }}>
              {balanceLogs.length > 0 ? balanceLogs.map((log: any) => (
                ...
                <div style={{ textAlign: 'center', padding: '40px', color: '#94a3b8' }}>Belum ada mutasi saldo.</div>
              )}
            </div>
          </div>
        )}
        ...
        {activeTab === 'history' && (
          <div style={{ background: 'white', padding: '28px', borderRadius: '24px', border: '1px solid #dcfce7', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
            <h3 style={{ fontSize: '20px', fontWeight: 900, color: '#166534', marginBottom: '20px' }}>Riwayat Pembelian</h3>
            <div style={{ display: 'grid', gap: '12px' }}>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <h3 style={{ fontSize: '22px', fontWeight: 900, color: '#111827', margin: 0 }}>Isi Saldo Wallet</h3>
            ...
            {topupTab === 'otomatis' ? (
              <>
                <p style={{ fontSize: '14px', color: '#6b7280', marginBottom: '20px' }}>Saldo akan bertambah otomatis setelah pembayaran berhasil.</p>
              ...
              <div style={{ textAlign: 'center' }}>
                {!manualOrderId ? (
                  <form onSubmit={handleTopup}>
                    <p style={{ fontSize: '14px', color: '#6b7280', marginBottom: '20px' }}>Masukkan jumlah saldo yang ingin Anda isi secara manual.</p>
                    <div style={{ marginBottom: '24px' }}>
